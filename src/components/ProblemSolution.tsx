  ...
  return (
    <section className="py-24 bg-white">
      <div className="mx-auto px-4 max-w-6xl">
        <h2 className="text-3xl md:text-4xl font-bold mb-16 text-center text-purple-700">
          Problem & Solution
        </h2>
        ...
        <div className="grid md:grid-cols-5 gap-8 items-center">
          ...
          <div className="md:col-span-2 bg-white p-8 rounded-2xl shadow-lg relative">
            ...
            <h3 className="text-xl font-bold mb-4 mt-4 text-gray-800">The Problem</h3>
          ...
          <div className="md:col-span-1 flex justify-center">
            <div className="w-20 h-20 rounded-full bg-yellow-300 flex items-center justify-center shadow-lg">
              <Smile className="w-12 h-12 text-purple-900" />
            </div>
          </div>
          ...
          <div className="md:col-span-2 bg-white p-8 rounded-2xl shadow-lg relative">
            ...
            <h3 className="text-xl font-bold mb-4 mt-4 text-gray-800">Our Solution</h3>
            <p className="text-gray-700">
